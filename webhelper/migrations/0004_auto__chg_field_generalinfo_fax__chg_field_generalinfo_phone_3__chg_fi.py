...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'webhelper_generalinfo', 'fax', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'GeneralInfo.phone_3'
        db.alter_column(u'webhelper_generalinfo', 'phone_3', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'GeneralInfo.phone_2'
        db.alter_column(u'webhelper_generalinfo', 'phone_2', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))
    ...
    models = {
        ...
        u'webhelper.generalinfo': {
            ...
            'phone_3': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
