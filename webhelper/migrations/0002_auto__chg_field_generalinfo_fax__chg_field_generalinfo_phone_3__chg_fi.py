...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GeneralInfo.fax'
        db.alter_column(u'webhelper_generalinfo', 'fax', self.gf('django.db.models.fields.CharField')(max_length=11, null=True))

        # Changing field 'GeneralInfo.phone_3'
        db.alter_column(u'webhelper_generalinfo', 'phone_3', self.gf('django.db.models.fields.CharField')(max_length=11, null=True))

        # Changing field 'GeneralInfo.tollfree'
        db.alter_column(u'webhelper_generalinfo', 'tollfree', self.gf('django.db.models.fields.CharField')(max_length=11, null=True))

        # Changing field 'GeneralInfo.phone_2'
        db.alter_column(u'webhelper_generalinfo', 'phone_2', self.gf('django.db.models.fields.CharField')(max_length=11, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'GeneralInfo.fax'
        db.alter_column(u'webhelper_generalinfo', 'fax', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'GeneralInfo.phone_3'
        db.alter_column(u'webhelper_generalinfo', 'phone_3', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'GeneralInfo.tollfree'
        db.alter_column(u'webhelper_generalinfo', 'tollfree', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'GeneralInfo.phone_2'
        db.alter_column(u'webhelper_generalinfo', 'phone_2', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'GeneralInfo.phone_1'
        db.alter_column(u'webhelper_generalinfo', 'phone_1', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'webhelper.generalinfo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'phone_1': ('django.db.models.fields.CharField', [], {'max_length': '11', 'null': 'True', 'blank': 'True'}),
